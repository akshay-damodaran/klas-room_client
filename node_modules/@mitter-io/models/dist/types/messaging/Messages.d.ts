...
export declare class Message implements IdentifiableEntity<Message>, MetadataAttachable {
    ...
    constructor(senderId: {
        identifier: string;
    } | string, textPayload: string, timelineEvents: Array<TimelineEvent>, payloadType?: string, messageId?: string | null, messageData?: Array<MessageDatum>, messageType?: StandardMessageType, entityMetaData?: EntityMetadata);
    identifier(): string;
}
export declare class ChannelReferencingMessage implements IdentifiableEntity<Message>, MetadataAttachable {
    ...
    timelineEvents: Array<TimelineEvent>;
    entityMetaData: EntityMetadata;
    constructor(channelId: string, messageId: string, messageType: StandardMessageType, payloadType: string, senderId: {
        identifier: string;
    }, textPayload: string, messageData: Array<MessageDatum>, timelineEvents: Array<TimelineEvent>, entityMetaData: EntityMetadata);
    identifier(): string;
}
