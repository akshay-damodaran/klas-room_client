...
var ChannelParticipation = /** @class */ (function () {
    function ChannelParticipation(participant, participationStatus, channelId) {
...
var Message = /** @class */ (function () {
    function Message(senderId, textPayload, timelineEvents, payloadType, messageId, messageData, messageType, entityMetaData) {
...
var Presence = /** @class */ (function () {
    function Presence(type, timeToLiveL, expiresTo) {
        this.type = type;
        this.timeToLiveL = timeToLiveL;
        this.expiresTo = expiresTo;
    }
    return Presence;
}());

var StandardUserProfileAtrributes;
...
})(StandardUserProfileAtrributes || (StandardUserProfileAtrributes = {}));
